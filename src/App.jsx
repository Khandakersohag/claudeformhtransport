...
function QuickEntry({data,setData,gotoPage}){
  const{settings,dailyRecords}=data;
  const[carCount,setCarCount]=useState(0);
  const[tripCount,setTripCount]=useState(0);
...
export default function App(){
  ...
  const pages={dashboard:<Dashboard {...p}/>,quick:<QuickEntry {...p} gotoPage={goto}/>,daily:<DailyEntry {...p}/>,vehicles:<VehicleManagement {...p}/>,staff:<StaffSalary {...p}/>,expenses:<ExpenseTracker {...p}/>,tasks:<TaskManagement {...p}/>,monthly:<MonthlyChart {...p}/>,search:<SearchFilter {...p}/>,reports:<Reports {...p}/>,settings:<SettingsPage {...p}/>};
